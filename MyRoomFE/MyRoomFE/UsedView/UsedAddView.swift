...
struct UsedAddView: View {
    ...
    @State private var selectMyItem: [String] = []
...
//                        UsedItemTestView(selectMyItem: $selectMyItem)
//                       .edgesIgnoringSafeArea(.all)
//               }
                
                VStack(alignment: .leading,spacing: 10) {
                    if !selectMyItem.isEmpty {
//                        Section(header: Text("추가 정보")) {
                        Text("Item Info")
                            ...
                            .padding(.horizontal)
                        VStack {
                            itemInfo(title: "구매일자", selectMyItem: selectMyItem, index: 0)
                            itemInfo(title: "구매가격", selectMyItem: selectMyItem, index: 1)
                            itemInfo(title: "유통기한", selectMyItem: selectMyItem, index: 3)
                            itemInfo(title: "개봉일자", selectMyItem: selectMyItem, index: 3)
                            itemInfo(title: "제품명", selectMyItem: selectMyItem, index: 3)
                            itemInfo(title: "추가설명", selectMyItem: selectMyItem, index: 2)
                        }
                        .padding()
...
//                .background(Color(UIColor.systemGroupedBackground))
    ...
    private func itemInfo(title:String,selectMyItem: [String],index:Int ) -> some View {
        HStack {
            Text(title)
                .font(.body)
                .foregroundColor(.secondary)
            Spacer()
            Text(selectMyItem[index].isEmpty ? " - " : selectMyItem[index])
                .font(.body)
